...
/users/0/buona008/andrew/magma --gene-results /users/0/buona008/andrew/personality_iq_project/jack_enrich_corr/gene_enrichments/"${BASE}".genes.raw --set-annot "$gmt_file" --out "${OUT_DIR}/${BASE}"
    done
done