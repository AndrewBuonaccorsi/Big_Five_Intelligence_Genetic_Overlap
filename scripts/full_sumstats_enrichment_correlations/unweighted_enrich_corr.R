...
setwd("/users/0/buona008/andrew/personality_iq_project/jack_enrich_corr/temp_dir")
...
setwd("/users/0/buona008/andrew/personality_iq_project/jack_enrich_corr/unweighted_geneset_corr")
