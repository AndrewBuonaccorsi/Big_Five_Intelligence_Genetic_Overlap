...
#SBATCH --array=0-11              # This number of traits minus
#SBATCH --output=magma_jack_%A_%a.out
#SBATCH --error=magma_jack_%A_%a.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=buona008@umn.edu

cd /users/0/buona008/andrew/personality_iq_project/split_half

TRAITS=(ReGPC_agr_half_one_no23_dir ReGPC_agr_half_two_no23_dir ReGPC_ext_half_one_no23_dir ReGPC_ext_half_two_no23_dir ReGPC_con_half_one_no23_dir ReGPC_con_half_two_no23_dir ReGPC_neu_half_one_no23_dir ReGPC_neu_half_two_no23_dir ReGPC_ope_half_one_no23_dir ReGPC_ope_half_two_no23_dir iq_male_dir iq_female_dir)
N_JK=200
